package com.example.amreth_day9cw2.modal;

import jakarta.persistence.Entity;
import jakarta.persistence.Id;

@Entity
public class AmrethVillage {
    @Id
    ...
    public AmrethVillage(){}
    public AmrethVillage(int villageId, String villageName, int numOfMen, int numOfWomen, int villagePopulation,
            int numOfSchools) {
